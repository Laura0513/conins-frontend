...
CREATE TABLE IF NOT EXISTS instructores (
    ...
    tipo_vinculacion ENUM('contrato','planta') NOT NULL DEFAULT 'contrato' COMMENT 'Define el maximo de carga semanal: contrato=40h, planta=32.5h',
...
CREATE TABLE IF NOT EXISTS horarios (
    id            INT AUTO_INCREMENT PRIMARY KEY,
    ficha_id      INT NULL COMMENT 'NULL en formacion complementaria (no tiene grupo)',
    instructor_id INT NOT NULL,
    competencia_id INT NULL COMMENT 'NULL en formacion complementaria',
